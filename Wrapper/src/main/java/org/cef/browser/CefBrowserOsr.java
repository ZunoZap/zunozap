...
class CefBrowserOsr extends CefBrowser_N implements CefRenderHandler {
    ...
    private GLJPanel canvas_; // ZUNOZAP: GLCanvas -> GLJPanel
    ...
    private void createGLCanvas() {
                    ...
                    if (OS.isMacintosh() && System.getProperty("java.runtime.version").startsWith("1.8")) {
                        ...
                        try {
                            if (scaleFactorAccessor == null) {
                                scaleFactorAccessor = getClass().getClassLoader()
        ...
        canvas_.addMouseWheelListener(new MouseWheelListener() {
            ...
            public void mouseWheelMoved(MouseWheelEvent e) {
                // ZUNOZAP - Fix: FxJCEF #1
                MouseWheelEvent e2 = new MouseWheelEvent((Component) e.getSource(), e.getID(), e.getWhen(), e.getModifiers(),
                        e.getX(), e.getY(), e.getClickCount(), e.isPopupTrigger(), e.getScrollType(), e.getScrollAmount()*-16, e.getWheelRotation());
